# -*- coding: utf-8 -*-
"""
Created on Mon Dec 19 00:57:49 2016

@author: stephaniekwan

Bootstraps 1-sigma uncertainties for the flux from the 2000 Sep 16 2MASS
observations of IC 10 X-2 in the JHK bands.
http://vizier.cfa.harvard.edu/viz-bin/VizieR-5?-ref=VIZ58577027422a&-out.add=.&-source=II/246/out&2MASS===00202090%2b5917590
...
hX2CircMean, hX2CircNpx, hX2AnnMean, hX2AnnStd = \
     np.array([39.038462, 452, 32.482086, 7.8577845])
...
jX2CircMean, jX2CircNpx, jX2AnnMean, jX2AnnStd = \
    np.array([16.810178, 452, 12.76937, 11.097855])
...
for i in range(iters):              
    ...
    jFluxrand[i] = randNorm(jFnu0, jFnu0sig) *10**3 * \
                            10 ** (-randNorm(16.45, 0.15) /2.5)
jX2Flux_mu, jX2Flux_sig = norm.fit(jX2Flux_rand)   # Extract values
jFlux, jFluxsig = norm.fit(jFluxrand)
...
print 'J BAND: zero-flux mag of ' + str(jZeroPt) + ' +/-' + str(jZeroPtsig) + \
 ...
 'Bonus round: actually 2000 Sep 2MASS J flux: ' + str(jFlux) + ' +/- ' + str(jFluxsig)
