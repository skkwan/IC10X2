...
#ax1.text(1.084- 0.0005, 1.5, 'He I (shifted)', color = 'red', rotation = 90, 
#         fontsize = 12)
...
#ax1.text(1.095- 0.0005, 1.5, 'Pa$\gamma$', rotation = 90, 
...
plt.savefig('170521 TSpec and Groh plot.pdf')    